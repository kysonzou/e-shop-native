...
// Source: ./internal/user-srv/biz/user.go
...
func (mr *MockUserServiceMockRecorder) GetMyProfile(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPasswordHashMockRecorder) Virefy(password, hashedPassword interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
